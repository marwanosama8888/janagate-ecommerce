         ...
         @endif
                <form id="myForm" action="{{ url('vendor/store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-img-all">
                        <div class="box-div">
                          <div class="box-img">
                            <img id="file-ip-1-preview" src="{{asset('assets/images/img-box-page.png')}}" alt="" />
                        ...
                        <div class="box-div">
                          <div class="box-img">
                            <img id="file-ip-2-preview" src="{{asset('assets/images/img-box-page.png')}}" alt="" />
                        ...
                        <div class="box-div">
                          <div class="box-img">
                            <img id="file-ip-3-preview" src="{{asset('assets/images/img-box-page.png')}}" alt="" />
                        ...
                        <div class="box-div">
                          <div class="box-img">
                            <img id="file-ip-4-preview" src="{{asset('assets/images/img-box-page.png')}}" alt="" />
                    ...
                    <div class="sec-four">
                      ...
                      <div class="sec-five">
                        ...
                        <input required name="info" type="text" />
                        <h5>{{ trans('vendor.material') }}</h5>
                        <input required name="material" type="text" />
                        <h5>{{ trans('vendor.weight') }}</h5>
                        <input name="weight" required type="number" />
                        <h5>{{ trans('vendor.handw') }}</h5>
                        <input required name="widthHeight" type="text" />
                      </div>
                      <hr />
                      <div class="sec-sex">
                        <h5>{{ trans('vendor.desc') }}</h5>
                        <textarea required name="description" >{{ trans('vendor.desc') }}</textarea>

                    </div>
                    <input name="prop" placeholder="Size Or Color Or ..." type="text">

                    <br><br><br>
                    <center>
                    <input type="text" name="value[]" value="" data-role="tagsinput" placeholder="Add Values" />
                    </center>
